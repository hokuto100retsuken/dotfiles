...
set -q FZF_DEFAULT_OPTS; or set -U FZF_DEFAULT_OPTS "--height $FZF_TMUX_HEIGHT --border --preview-window=wrap"
...
if not command -q fzf
    echo "Warning: fzf is not installed. Please install fzf to use fuzzy search features."
    return
end
